...
public class Pathway : MonoBehaviour
{
	...
	void Update()
	{
		...
		if(waypoints.Length > 1)
		{
			...
			{
				// Ve duong thang trong edit mode
				Debug.DrawLine(waypoints[idx - 1].transform.position, waypoints[idx].transform.position, Color.blue);
			}
		}
	}
	//Chon diem gan nhat de tham chieu
	/// <returns> the nearest waypoint. </return>
	...
	public Waypoint GetNearestWayPoint(Vector3 position)
	{
		...
		{
			// Tinh khoang cach toi diem waypoint
	...
	/// <summary>
	/// Lay diem waypoint tiep theo tren duong thang
	/// </summary>
